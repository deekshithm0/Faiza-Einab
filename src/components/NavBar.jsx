...
const NavBar = () => {
  ...
  return (
    <div className="flex flex-col items-center max-w-full">
      {/* Desktop Navigation */}
      <div className="h-20 flex justify-between px-32 max-md:px-10 max-sm:hidden items-center w-full bg-backgound">
        <div>Faiza einab</div>
        ...
        <div className="border border-yellow-500 text-yellow-500 rounded-3xl px-3 py-1 z-10 text-white">

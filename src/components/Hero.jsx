...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className=" sm:h-auto overflow-hidden xs:ml-0 xs:h-2/4  z-10 bg-cover bg-center flex xs:gap-3 lg:gap-64 max-sm:flex-col items-center justify-evenly px-16">

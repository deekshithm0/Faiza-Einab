...
const Hero = () => {
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="h-screen flex flex-col overflow-y-scroll hideScrollBar max-w-full"
    >
      <motion.div
        variants={{ hidden: { opacity: 0 }, visible: { opacity: 1 } }}
        className=" h-[calc(100vh-5rem)]  flex items-center justify-center "
      >
        <div className="h-[calc(100vh-5rem)] max-sm:h-auto  z-10 bg-cover bg-center flex max-sm:flex-col items-center justify-evenly px-16">
          <div className="flex flex-col gap-4 w-full py-5">
            <h1 className="font-italiana text-[3rem] max-sm:w-3/4 sm:text-[3rem] md:text-[5rem] lg:text-[6rem] xl:text-[7rem] leading-tight text-[#582E7D]">
              Simply <br /> Pure, Simply <br /> Delecious!
            </h1>
            <button
              className="w-40 h-12  rounded-3xl bg-[#582E7D] text-white text-center"
      ...
      >
        <div className="h-1/3 w-full flex felx item-center justify-center gap-4 pr-40">
          <div>
            <img
              src={ProductImg2}
              alt="productImg2"
          ...
          <div className="flex   flex-col text-end gap-4 pr-16  bg-[#582E7D] rounded-2xl bg-opacity-20">
            <h2 className="font-shadowsIntoLight font-bold text-[50px] pt-3 pb-5 text-[#582E7D]">
              ProductName 2
            </h2>
        ...
        <div className="h-1/3 w-full flex felx justify-center items-center gap-4  ">
        ...
        <div className="h-[50rem] w-full flex flex-col gap-5 justify-center items-center">
          ...
          <div className="h-[50rem] pb-24 flex flex-row w-full items-center ">
